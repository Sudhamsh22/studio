...
function CompleteProfileForm() {
        ...
        <>
            ...
            <FormField control={form.control} name="graduationYear" render={({ field }) => (
                <FormItem>
                    ...
                    <FormControl><Input type="number" placeholder="e.g., 2026" {...field} /></FormControl>
                    <FormMessage />
                </FormItem>
            )} />
        </>
    ...
    const renderPmFields = () => (
        <>
            ...
            <FormField control={form.control} name="methodologies" render={({ field }) => (
                <FormItem>
                    <FormLabel>Agile Methodologies</FormLabel>
                    <FormControl><Input placeholder="e.g., Scrum, Kanban" {...field} /></FormControl>
                    <FormMessage />
                </FormItem>
            )} />
    ...
    const renderAdminFields = () => (
        <FormField control={form.control} name="department" render={({ field }) => (
            <FormItem>
                ...
                <FormControl><Input placeholder="e.g., Platform Operations" {...field} /></FormControl>
                <FormMessage />
            </FormItem>
        )} />
    );
    ...
    const renderFields = () => {
        switch (role) {
            case 'pm': return renderPmFields();
            case 'admin': return renderAdminFields();
    ...
    const getTitle = () => {
        switch (role) {
            case 'pm': return 'Project Manager Profile';
            case 'admin': return 'Administrator Profile';
      ...
      <Card className="w-full max-w-2xl">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
              <CardTitle className="font-headline text-2xl">Complete Your {getTitle()}</CardTitle>
              <CardDescription>
