    ...
    <Section id={id}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <SpotlightCard key={project.title} spotlightColor="hsl(var(--primary) / 0.2)">
            <Card  className="flex flex-col bg-card/50 border-border/50 backdrop-blur-sm transition-all h-full">
              <CardHeader>
